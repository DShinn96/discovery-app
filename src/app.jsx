              ...
              {[
                {
                  ...
                  desc: "Performance-first websites designed to turn visitors into leads.",
                },
                {
                  title: "Software Engineering",
                  icon: "🚀",
                  tech: "C# • Node.js • .NET Core",
                  desc: "Custom back-end solutions specialized in automating business logic.",
                },
                {
                  title: "Data Architecture",
                  icon: "💾",
                  tech: "PostgreSQL • SQL Server • T-SQL",
                  desc: "Clean database design to ensure your data is secure and scalable.",
                },
              ].map((s, i) => (
                <div
                  key={i}
          ...
          <div className="w-full max-w-5xl animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="bg-slate-900 border border-slate-800 rounded-3xl overflow-hidden group hover:border-blue-500 transition-all flex flex-col"
              >
                ...
                <div className="p-8">
                  ...
                  <p className="text-slate-400 text-sm mb-4 leading-relaxed">
                    A specialized web app for tracking live sports data and game
                    metrics in real-time. Built for mobile-first performance.
                  </p>
                  <div className="flex gap-2">
                    {["Vite", "React", "Vercel"].map((t) => (
                      <span
                        key={t}
                        className="text-[10px] bg-slate-800 text-slate-400 px-2 py-1 rounded uppercase font-bold"
                      >
                        {t}
                      </span>
                    ))}
