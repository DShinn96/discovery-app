...
// 2026 Bulletproof Imports (Lowercase Enforcement)
import { questions } from "@/features/discovery/data";
import LeadForm from "@/features/discovery/components/lead-form";
        ...
        <div className="w-full max-w-2xl relative z-10">
          <AnimatePresence mode="wait">
            {!showForm && !showResult ? (
              ...
              >
                <div className="absolute top-0 left-0 w-full h-px bg-blue-500/30 shadow-[0_0_15px_#3b82f6] animate-scan will-change-transform" />
